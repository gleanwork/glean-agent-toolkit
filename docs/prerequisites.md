...
- Environment variables
  ...
  - `GLEAN_API_TOKEN`
  - `GLEAN_SERVER_URL` (or deprecated `GLEAN_INSTANCE`)
...
- 401/403 errors: validate `GLEAN_API_TOKEN`, `GLEAN_SERVER_URL` (or deprecated `GLEAN_INSTANCE`), and user permissions
