...
try:
    from glean_agent_toolkit.toolkit.adapters.openai import HAS_OPENAI
except ImportError:
    HAS_OPENAI = False

try:
    from glean_agent_toolkit.toolkit.adapters.adk import HAS_ADK
except ImportError:
    HAS_ADK = False

try:
    from glean_agent_toolkit.toolkit.adapters.langchain import HAS_LANGCHAIN
except ImportError:
    HAS_LANGCHAIN = False

try:
    from glean_agent_toolkit.toolkit.adapters.crewai import HAS_CREWAI
except ImportError:
    HAS_CREWAI = False
